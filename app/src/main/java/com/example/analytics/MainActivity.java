        ...
        mDatabase.child("Questions").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (i=0; i < progressList.getChildCount(); i++) {
                    ImageView imageQ = findViewById(imageQuestions[i]);
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    for (i=0; i < progressList.getChildCount(); i++) {
                        ...
                        if (key.equalsIgnoreCase(key2)) {
                            ...
                            //TextView
                            TextView textQ = findViewById(textLetters[i]);
                            ...
                            ProgressBar progressQ = findViewById(progressBars[i]);
                ...
                for (i=0; i < progressList.getChildCount(); i++) {
                    ...
                    if (text.equalsIgnoreCase("empty")) {
                        ...
                        //Toast.makeText(MainActivity.this, String.valueOf(imageQ.getParent().getParent()), Toast.LENGTH_SHORT).show();
                    }
                }
